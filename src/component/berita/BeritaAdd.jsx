...
function BeritaAdd() {
    ...
    const saveHandler = async (e) => {
      ...
      //send data with API
      await axios.post('http://202.10.41.84:5000/api/berita/create', formData,{
        headers: {
  ...
  <section className="content">
    ...
    <div className="card">
      <div className="card-header">
        <h3 className="card-title">Tambah Berita</h3>
      ...
      <form onSubmit={saveHandler}>
      {
            ...
            <div className="form-group">
                ...
                <textarea className="form-control" onChange={(e) => setContent(e.target.value)} rows="5" placeholder="Isi Berita"></textarea>
            </div>
            <div className="form-group">
                <label>Email</label>
